    ...
    <section id="beranda" className="relative bg-hkti-forest text-white overflow-hidden py-16 sm:py-24 lg:py-28">
      ...
      >
        <img
          ...
          alt="Pelantikan Pengurus DPC HKTI Kota Batam"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl space-y-6">
          ...
          {/* Metadata Badge: Dewan Pimpinan Pill Card & Separated Kepulauan Riau Location */}
          <motion.div
          ...
          >
            {/* Dewan Pimpinan Cabang Pill Card */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold text-emerald-200 tracking-wide uppercase">
              ...
              <span>DEWAN PIMPINAN CABANG • KOTA BATAM • PERIODE 2026–2030</span>
            </div>
          ...
          >
            {[
              'Menghimpun potensi petani,',
              'memodernisasi agribisnis,',
              'dan memperjuangkan kedaulatan pangan maritim & urban farming',
              'di Kota Batam demi martabat pertanian nusantara.',
            ].map((phrase, idx) => (
              <motion.span
                key={idx}
                variants={{
          ...
          >
            ...
            <div className="sm:hidden flex flex-col gap-3">
              ...
              {/* Button 2 Mobile: Galeri Pelantikan & Musda */}
              <Link
                href="/galeri"
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span>Galeri Pelantikan & Musda</span>
                </div>
            ...
            <div className="hidden sm:flex items-center gap-3.5">
              ...
              {/* Button 2 Desktop: Galeri Pelantikan & Musda (Translucent dark green + Images icon) */}
              <Link
                href="/galeri"
