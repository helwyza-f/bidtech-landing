...
- **Elemen Visual**:
  - Foto megah showroom & lobby eksekutif **PT. Nadim Auto Transindo** dengan logo dinding 3D NTR (`background-3.webp`), posisi dinaikkan agar logo 3D NTR tampak jelas di atas atap kendaraan.
  - Cutout unit **Toyota Alphard VIP** (`Alphard-2.webp`) dengan ukuran proporsional sedang (*medium*), kontak bayangan lantai yang realistis, dan efek parallax interaktif kursor mouse (*mouse-parallax*).
