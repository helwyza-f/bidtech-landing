...
const CATEGORY_TABS = [
  { id: "all", name: "Semua Design", count: 14, filterKey: "all" },
  { id: "automotive", name: "Otomotif", count: 1, filterKey: "Otomotif" },
  { id: "culinary", name: "Kuliner", count: 4, filterKey: "UMKM" },
  { id: "beauty", name: "Kecantikan", count: 3, filterKey: "Kecantikan" },
  { id: "community", name: "Komunitas", count: 3, filterKey: "Komunitas" },
  { id: "property", name: "Properti", count: 1, filterKey: "Konstruksi & Properti" },
  { id: "education", name: "Pendidikan", count: 2, filterKey: "Pendidikan" },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-7">
          {filteredTemplates.map((template, index) => {
            ...
            const views = viewCounts[template.id] ?? 80;
