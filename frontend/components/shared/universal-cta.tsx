        ...
        <div className="relative overflow-hidden rounded-[32px] sm:rounded-[40px] border border-[#cdeec3] bg-[radial-gradient(ellipse_at_top_right,rgba(163,230,53,0.3),transparent_60%),linear-gradient(135deg,#f0faee_0%,#fbfefb_45%,#edf8eb_100%)] p-6 sm:p-10 md:p-12 lg:p-14 shadow-[0_24px_70px_rgba(95,201,74,0.14)]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              <h2
                className="font-[family-name:var(--font-sora)] text-3xl sm:text-4xl lg:text-[44px] font-extrabold tracking-tight text-slate-950 leading-[1.18]"
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3 sm:gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2.5 rounded-full bg-[#45a02e] hover:bg-[#3d8e29] text-white px-6 sm:px-7 py-3.5 sm:py-4 text-sm font-bold shadow-[0_12px_28px_rgba(69,160,46,0.3)] transition-all duration-200 hover:-translate-y-0.5 active:scale-95 cursor-pointer"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-300 bg-white hover:bg-slate-50 text-slate-800 px-6 sm:px-7 py-3.5 sm:py-4 text-sm font-semibold shadow-sm transition-all duration-200 hover:-translate-y-0.5 active:scale-95 cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 relative flex items-center justify-center pt-6 lg:pt-0">
              <div className="relative w-full max-w-[440px] sm:max-w-[480px] lg:max-w-[500px]">
                ...
                <div className="absolute -top-6 left-0 sm:-top-8 sm:-left-4 z-20 flex items-center gap-3 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-100/90 px-3.5 sm:px-4 py-2 sm:py-2.5 shadow-[0_16px_36px_rgba(0,0,0,0.09)] transition-transform duration-300 hover:scale-105">
                  <div className="flex size-8 sm:size-9 shrink-0 items-center justify-center rounded-xl bg-[#e8f7e2] text-[#45a02e]">
                    <Zap className="size-4 sm:size-5 fill-[#45a02e] text-[#45a02e]" />
                  </div>
                  <div className="text-left">
                    <div className="flex items-center gap-1.5 text-xs sm:text-[13px] font-bold text-slate-900 leading-tight">
                ...
                <div className="absolute -bottom-5 right-0 sm:-bottom-6 sm:-right-2 z-20 flex items-center gap-3 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-100/90 px-3.5 sm:px-4 py-2 sm:py-2.5 shadow-[0_16px_36px_rgba(0,0,0,0.09)] transition-transform duration-300 hover:scale-105">
                  <div className="flex size-8 sm:size-9 shrink-0 items-center justify-center rounded-xl bg-[#e8f7e2] text-[#45a02e]">
                    <ShieldCheck className="size-4 sm:size-5 text-[#45a02e]" />
                  </div>
                  <div className="text-left">
                    ...
                    <div className="flex items-center gap-1 text-[11px] text-amber-500 mt-0.5">
                      ...
                      <span className="font-bold text-slate-700 ml-0.5 text-[11px]">5.0 Star</span>
                    </div>
                  </div>
                </div>
              </div>
