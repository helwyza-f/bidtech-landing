...
export function Features() {
  return (
    <section id="story" className="relative w-full bg-white dark:bg-[#121215] py-10 sm:py-16 md:py-24 scroll-mt-20">
      <div className="container-app">
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12 md:mb-16">
          <p className="text-eyebrow mb-2 sm:mb-4">Why choose us</p>
            ...
            >
              <Card className="h-full bg-neutral-50 dark:bg-card border-none shadow-sm hover:shadow-md transition-shadow rounded-2xl">
                <CardHeader className="p-5 sm:p-6">
                  <div className="size-10 sm:size-12 rounded-xl sm:rounded-2xl bg-brand-50 flex items-center justify-center mb-3 sm:mb-4">
                    {feature.icon}
                  </div>
