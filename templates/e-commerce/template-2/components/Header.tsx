...
export default function Header() {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/85 backdrop-blur-md border-b border-[#e2e2e2] shadow-sm' : 'bg-white border-b border-[#e2e2e2]'}`}>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full border-t border-[#e2e2e2] bg-white/95 backdrop-blur-md px-5 py-4 space-y-3 shadow-2xl">
            <Link
              href="/#catalog"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2.5 font-mono text-sm uppercase text-[#1a1c1c] border-b border-[#e2e2e2]"
            >
              Katalog
            </Link>
            <Link
              href="/#reviews"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2.5 font-mono text-sm uppercase text-[#7e7576] hover:text-[#1a1c1c] border-b border-[#e2e2e2]"
            >
              Ulasan
            </Link>
            <Link
              href="/kisah"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2.5 font-mono text-sm uppercase text-[#7e7576] hover:text-[#1a1c1c]"
            >
              Kisah
            </Link>
          </div>
