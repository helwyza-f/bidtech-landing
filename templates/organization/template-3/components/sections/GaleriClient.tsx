...
// 10 Items for Day 1: Pelantikan & Musda
const DAY1_ITEMS: GalleryStoryItem[] = [
  ...
  {
    id: 'day1-5',
    title: 'Semboyan Perjuangan & Kepemimpinan HKTI',
    category: 'DOKUMENTASI',
    imageUrl: '/images/MTW_3881.webp',
  },
  ...
  {
    id: 'day1-8',
    title: 'Rapat Kerja Strategis & Tata Kelola Pertanian',
    category: 'RAPAT KERJA',
    imageUrl: '/images/MTW_3885.webp',
  },
  {
    id: 'day1-9',
    title: 'Apresiasi Insan Tani & Pelaku Agribisnis',
    category: 'PENGHARGAAN',
    imageUrl: '/images/MTW_3895.webp',
  },
  {
    id: 'day1-10',
    title: 'Semboyan HKTI Jaya, Tani Makmur',
    category: 'SEMBOYAN',
    imageUrl: '/images/hero.webp',
  },
];

// 8 Items for Day 2: Sidang Pleno, Pemantapan Program & Penutupan
const DAY2_ITEMS: GalleryStoryItem[] = [
  // Row 1: Wide (2 col) + Single (1 col)
  {
    id: 'day2-1',
    title: 'Konsolidasi Akbar & Foto Bersama Pengurus DPD HKTI Kepulauan Riau (2026–2031)',
    category: 'AGENDA UTAMA DAY 2',
    imageUrl: '/images/day2/MVL_0859.webp',
    isWide: true,
    hasPillBadge: 'DOKUMENTASI DAY 2',
  },
  {
    id: 'day2-2',
    title: 'Pembacaan Doa Khidmat oleh Ust. Ahmad Abu Syahid',
    category: 'DOA BERSAMA',
    imageUrl: '/images/day2/MVL_0704.webp',
  },

  // Row 2: 3 Vertical Cards (1 col, 1 col, 1 col)
  {
    id: 'day2-3',
    title: 'Soliditas Barisan Pengurus Terpilih DPD & DPC HKTI se-Kepri',
    category: 'KONSOLIDASI DAERAH',
    imageUrl: '/images/day2/MVL_0806.webp',
  },
  {
    id: 'day2-4',
    title: 'Partisipasi & Kehadiran Tokoh Perempuan Tani Indonesia',
    category: 'PERWAKILAN TANI',
    imageUrl: '/images/day2/MVL_0610.webp',
  },
  {
    id: 'day2-5',
    title: 'Diskusi Panel & Pemantapan Strategi Ketahanan Pangan Maritim',
    category: 'DISKUSI STRATEGIS',
    imageUrl: '/images/day2/MVL_0770.webp',
  },

  // Row 3: Single (1 col) + Wide (2 col)
  {
    id: 'day2-6',
    title: 'Penyampaian Program Kerja & Dialog Interaktif Kelembagaan',
    category: 'PROGRAM KERJA',
    imageUrl: '/images/day2/MVL_0720.webp',
  },
  {
    id: 'day2-7',
    title: 'Ramah Tamah & Sesi Penutupan Rangkaian Acara Hari Ke-2',
    category: 'PENUTUPAN RESMI',
    imageUrl: '/images/day2/MVL_0898.webp',
    isWide: true,
  ...
  {
    id: 'day2-8',
    title: 'Antusiasme Peserta & Delegasi Tani se-Kota Batam',
    category: 'AUDIENSI & PESERTA',
    imageUrl: '/images/day2/MVL_0625.webp',
    isFullWidth: true,
    hasPillBadge: 'KEBERSAMAAN TANI',
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-hkti-mint border border-emerald-200/80 text-hkti-forest text-xs font-bold uppercase tracking-wider mb-3">
              ...
              <span>DOKUMENTASI RESMI • DPC HKTI KOTA BATAM</span>
            </div>
            ...
            <p className="text-sm sm:text-base text-slate-600 mt-2.5 max-w-2xl mx-auto">
              Arsip visual resmi rekam jejak pelantikan akbar, sidang pleno, konsolidasi program kerja, dan kebersamaan insan tani Kota Batam.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center mb-8 sm:mb-12">
            <div className="inline-flex p-1.5 rounded-2xl bg-white border border-slate-200/90 shadow-2xs gap-1 sm:gap-2 max-w-full overflow-x-auto">
              ...
              >
                ...
                <span>Day 1 — Pelantikan & Musda</span>
                <span
                  className={`px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-semibold ${
          ...
          {/* ========================================================================= */}
          {/* SECTION 1: DOKUMENTASI DAY 1 (PELANTIKAN & MUSDA)                         */}
          {/* ========================================================================= */}
              ...
              <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-3 border-b border-slate-200/80 pb-4">
                <div>
                  ...
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-hkti-slate tracking-tight">
                    Pelantikan Akbar, Prosesi Pataka & Musda
                  </h2>
                </div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
                    ...
                    <div className="flex items-center -space-x-1.5 mt-2.5">
                      ...
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0806.webp')}
                        alt="Pengurus"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0610.webp')}
                        alt="Kader"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                    </div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
                    ...
                    <div className="flex items-center -space-x-1.5 mt-2.5">
                      ...
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0704.webp')}
                        alt="Doa"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                    </div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
                    ...
                    <div className="flex items-center -space-x-1.5 mt-2.5">
                      ...
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0770.webp')}
                        alt="Panel"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                    </div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
                    ...
                    <div className="flex items-center -space-x-1.5 mt-2.5">
                      ...
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0720.webp')}
                        alt="Dialog"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                    </div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
                    ...
                    <div className="flex items-center -space-x-1.5 mt-2.5">
                      ...
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0898.webp')}
                        alt="Penutupan"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                    </div>
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 sm:right-5">
                    ...
                    <div className="flex items-center -space-x-1.5 mt-2.5">
                      ...
                      />
                      <img
                        src={getAssetPath('/images/day2/MVL_0625.webp')}
                        alt="Audiensi"
                        className="w-6 h-6 rounded-full border-2 border-white/80 object-cover shadow-xs"
                      />
                    </div>
