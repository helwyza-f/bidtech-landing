  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      onFormSuccess(
        ...
        'Aspirasi Anda telah diterima oleh DPC HKTI Kota Batam. Tim kami akan menghubungi via WhatsApp.'
      );
      setFormData({
        namaLengkap: '',
        nomorWhatsapp: '',
            ...
            <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium mt-0.5">Kantor DPC HKTI Kota Batam</p>
            ...
            <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs">
              <div className="flex items-start gap-3.5">
                ...
                <div className="space-y-1">
                  <h4 className="text-sm font-bold text-slate-900 mb-1">Layanan Aspirasi & Info</h4>
                  <p className="text-xs sm:text-sm text-slate-600">
                    <span className="font-semibold text-slate-700">Call Center Petani:</span> +62 778 412 8900
                  </p>
                  <p className="text-xs sm:text-sm text-slate-600">
                    <span className="font-semibold text-slate-700">WhatsApp Center:</span> +62 811 7700 892
                  </p>
                  <p className="text-xs sm:text-sm text-slate-600">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="kecamatan" className="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-1.5">
                    Kecamatan di Batam <span className="text-red-500">*</span>
                  </label>
                  <select
                    id="kecamatan"
                    required
            ...
            {isSuccess && (
              <div className="mt-4 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900 transition-all">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h5 className="text-sm font-bold">Terima Kasih! Aspirasi Berhasil Dikirim.</h5>
                    <p className="text-xs text-emerald-700 mt-0.5">
                      Tim Sekretariat DPC HKTI Kota Batam akan meninjau dan menghubungi Anda melalui WhatsApp.
                    </p>
                  </div>
                </div>
              </div>
