...
/**
 * Accordion FAQ generik — dipakai di halaman detail (Beasiswa, Bootcamp,
 * dst) yang merupakan server component, sehingga interaktivitasnya perlu
 * dibungkus client component sendiri. Pola animasi disamakan dengan
 * FaqSection homepage supaya konsisten secara motion di seluruh situs.
 */
